 ...
 */
public class CallControls extends LinearLayout implements OnClickListener {
	...
	private void init(AttributeSet attrs) {
		...
		CheatSheet.setup(this.speakers, this.micro, this.video, this.camera, this.fullscreen, this.share, this.scale, this.hangup);
	...
	static class SavedState extends BaseSavedState {
		...
		protected SavedState(Parcel in) {
			super(in);
			this.activated = new boolean[8];
			this.visibility = new int[8];
	...
	protected Parcelable onSaveInstanceState() {
		...
		state.activated = new boolean[] { this.camera.isActivated(), this.video.isActivated(), this.speakers.isActivated(), this.micro.isActivated(), this.fullscreen.isActivated(), this.scale.isActivated(), this.share.isActivated(), this.hangup.isActivated() };
		state.visibility = new int[] { this.camera.getVisibility(), this.video.getVisibility(), this.speakers.getVisibility(), this.micro.getVisibility(), this.fullscreen.getVisibility(), this.scale.getVisibility(), this.share.getVisibility(), this.hangup.getVisibility() };
		return state;
	}
