...
public class CustomReportSender implements ReportSender {
	...
	private String buildSubject() {
		...
		return this.ctx.getString(R.string.crash_email_subject, this.ctx.getString(net.rtccloud.helper.R.string.app_name), Rtcc.getVersionFull(this.ctx), MODE.value, Util.getDeviceName(false));
	}
